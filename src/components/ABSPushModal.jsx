    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-neutral-900 rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden border border-neutral-800">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Info note */}
          <div className="bg-blue-950/50 border border-blue-900/50 rounded-xl p-4 text-sm text-blue-300">
            <p>
              <strong className="text-blue-200">Note:</strong> This will update metadata on your AudiobookShelf server.
