...
function AuthorDetail({ detail, issues, pendingChanges, onRename, onMerge, onFixDescription, onEditDescription, actionLoading }) {
  ...
  useEffect(() => {
    ...
    invoke('get_abs_author_image', { authorId: detail.id })
      .then(bytes => {
        if (cancelled) return;
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Books */}
      <div>
        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-3">Books ({detail.books.length})</h3>
            ...
            <div key={book.id} className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-neutral-900 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 text-xs text-gray-500 mt-0.5">
                  ...
                  {book.narrators.length > 0 && <span>Narrated by {book.narrators.join(', ')}</span>}
